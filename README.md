...
Como parte de las buenas prácticas de ingeniería aplicadas a este proyecto, se ha incorporado un archivo ![changelog.md](docs/CHANGELOG.md). Este archivo tiene como objetivo registrar de manera cronológica todas las modificaciones, actualizaciones y correcciones relevantes realizadas a lo largo de las cuatro fases de desarrollo: exploración, EDA y limpieza, rendimiento y POO, e integración y visualización. Adaptar esta herramienta, tradicionalmente vinculada al desarrollo de software, nos permite mantener una trazabilidad rigurosa de la evolución del proyecto y facilitar su gestión técnica.